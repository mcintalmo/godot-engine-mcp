...
class ClientManager(GodotClient):
    ...
    async def audit_orphan_nodes(
        ...
        client = await self.get_active_client()
        return await client.audit_orphan_nodes(
    ...
    async def capture_profiler_trace(
        ...
        client = await self.get_active_client()
        return await client.capture_profiler_trace(
    ...
    async def create_csg_shape(
        ...
        client = await self.get_active_client()
        return await client.create_csg_shape(
            shape_type=shape_type,
            node_name=node_name,
            parent_path=parent_path,
            operation=operation,
    ...
    async def generate_procedural_mesh(
        ...
        client = await self.get_active_client()
        return await client.generate_procedural_mesh(
            mesh_type=mesh_type,
            node_name=node_name,
            parent_path=parent_path,
            size=size,
    ...
    async def inspect_skeleton(
        ...
        client = await self.get_active_client()
        return await client.inspect_skeleton(
    ...
    async def configure_bone_attachment(
        ...
        client = await self.get_active_client()
        return await client.configure_bone_attachment(
            skeleton_node_path=skeleton_node_path,
            bone_name=bone_name,
    ...
    async def setup_inverse_kinematics(
        ...
        client = await self.get_active_client()
        return await client.setup_inverse_kinematics(
            skeleton_node_path=skeleton_node_path,
    ...
    async def configure_lightmap_gi(
        ...
        client = await self.get_active_client()
        return await client.configure_lightmap_gi(
            gi_type=gi_type,
            node_name=node_name,
            parent_path=parent_path,
            quality=quality,
    ...
    async def bake_lightmaps(
        ...
        client = await self.get_active_client()
        return await client.bake_lightmaps(
    ...
    async def setup_xr_rig(
        ...
        client = await self.get_active_client()
        return await client.setup_xr_rig(
            rig_name=rig_name,
            parent_path=parent_path,
    ...
    async def configure_xr_passthrough(
        ...
        client = await self.get_active_client()
        return await client.configure_xr_passthrough(
    ...
    async def scatter_multimesh(
        ...
        client = await self.get_active_client()
        return await client.scatter_multimesh(
            mesh_path=mesh_path,
            node_name=node_name,
            parent_path=parent_path,
    ...
    async def configure_lod_manager(
        ...
        client = await self.get_active_client()
        return await client.configure_lod_manager(
            node_path=node_path,
