...
from godot_mcp.client.headless.physics_mixin import PhysicsHeadlessMixin
from godot_mcp.client.headless.project_mixin import ProjectHeadlessMixin
from godot_mcp.client.headless.rendering_mixin import RenderingHeadlessMixin
from godot_mcp.client.headless.scene_mixin import SceneHeadlessMixin
