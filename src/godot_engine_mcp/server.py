...
from godot_engine_mcp.models.animation import CreateAnimationInput
...
from godot_engine_mcp.models.editor_history import (
    RedoInput,
    UndoInput,
)
...
from godot_engine_mcp.models.performance import GetPerformanceMetricsInput
